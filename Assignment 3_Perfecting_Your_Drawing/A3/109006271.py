...
Original file is located at
    https://colab.research.google.com/drive/11OOQJ-h8T0NDYyblSu8PDiCaGjXghc1m
"""
...
def ellipse(sp) : #A,b
    ...
    for i in range(n):
        ...
        x = pt[0]
        y = pt[1]
        # TODO: ellipse formula here. Ax = b
        A[i, :] = [x*x,x*y,y*y,x,y]
        b[i] = 1.
        #A[i, :] = [2.*pt[0], 2.*pt[1], 1]
        #b[i] = pt[0]*pt[0]+pt[1]*pt[1]
...
def main(file, mode="ellipse") :
    ...
    if mode == "circle":
        ...
        [x,r,rank] = np.linalg.lstsq(np.dot(A.T,A),np.dot(A.T,b))[0:3]
        ...
        # solve the least square problem
        [x, r, rank] = np.linalg.lstsq(A, b, rcond=-1)[0:3]
...
files = ['case1.png', 'case2.png', 'case3.png','case4.png','mycircle1.png','mycircle2.png','mycircle3.png','mycircle1.png','mycircle3.png','myellipse2.png']#'myellipse2.png''myellipse3.png' 
#for f in files :
#    main('/content/drive/My Drive/' + f, mode="circle")
#    main('/content/drive/My Drive/' + f, mode="ellipse")
#main('/content/drive/My Drive/mycircle1.png', mode="circle")
main('/content/drive/My Drive/myellipse3.png', mode="ellipse")